...
object UpdateChecker {
    ...
    fun checkForUpdate(context: Context, currentVersion: String): UpdateInfo {
        ...
        return try {
            ...
            ErrorLogger.log(ErrorLogger.Codes.GEN_UPDATE_CHECK, "Network request failed", e)
    ...
    private fun extractTagName(json: String): String? {
        return try {
            ...
            ErrorLogger.log(ErrorLogger.Codes.GEN_UPDATE_CHECK, "Failed to parse tag_name", e)
            null
        }
    }
